...
describe('get activity text', () => {
  test.each([
    ...
    { journeyType: loginTypes.claim, expectedText: 'The email includes a link to claim funding. This link will expire in 15 minutes.' },
    { journeyType: loginTypes.vet, expectedText: 'The email includes a link to record information about the review. This link will expire in 15 minutes.' }
