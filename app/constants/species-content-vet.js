module.exports = {
  ...
  dairy: {
    errorText: 'Select yes if there were 11 or more cattle in the herd',
  ...
  pigs: {
    ...
    legendText: 'Were there more than 51 pigs on the farm at the time of the review?',
    title: 'Were there more than 51 pigs on the farm at the time of the review?'
  },
  sheep: {
    errorText: 'Select yes if there were 21 or more sheep on the farm at the time of the review',
