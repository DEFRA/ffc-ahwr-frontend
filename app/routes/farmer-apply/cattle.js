...
module.exports = [
  {
    ...
    options: {
      handler: async (request, h) => {
        return h.view('farmer-apply/cattle', getYesNoRadios(legendText, radioId))
      }
    }
  },
  {
    ...
    options: {
      validate: {
        ...
        failAction: (request, h, err) => {
          return h.view('farmer-apply/cattle', getYesNoRadios(legendText, radioId, errorText)).takeover()
        }
      },
      handler: async (request, h) => {
