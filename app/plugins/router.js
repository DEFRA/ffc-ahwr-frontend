const routes = [].concat(
  ...
  require('../routes/farmer-apply/beef-eligibility'),
  ...
  require('../routes/farmer-apply/dairy-eligibility'),
  require('../routes/farmer-apply/declaration'),
  require('../routes/farmer-apply/not-eligible'),
  require('../routes/farmer-apply/org-review'),
  require('../routes/farmer-apply/pigs-eligibility'),
  require('../routes/farmer-apply/sheep-eligibility'),
